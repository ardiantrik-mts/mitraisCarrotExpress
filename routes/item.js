...
router.post('/item', itemController.items_post)
router.get('/item', itemController.items_get)
router.get('/item/:name', itemController.items_getName)
router.patch('/item/:id', itemController.items_update)
router.delete('/item/:id', itemController.items_delete)
